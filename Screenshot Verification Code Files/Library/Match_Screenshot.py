...
def matchingFilesInIssueScreenshotPathWithIssueScreenshot(df, issueScreenshotPath, columnNameForScreenshotName):
	...
	issueScreenshot = df[columnNameForScreenshotName].str.lower().str.strip()
